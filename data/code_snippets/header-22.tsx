...
export type Header22Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Header22 = (props: Header22Props) => {
...
export const Header22Defaults: Header22Props = {
