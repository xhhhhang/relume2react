...
<div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 border border-border-primary p-8 md:gap-y-16 md:p-12 lg:grid-cols-[0.75fr,1fr] lg:gap-y-4">
...
export const Footer9Defaults: Footer9Props = {
  logo: {
    url: "#",
