...
export type Timeline4Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Timeline4 = (props: Timeline4Props) => {
...
<div className="ml-12 border border-border-primary md:ml-0">
...
export const Timeline4Defaults: Timeline4Props = {
  tagline: "Tagline",
