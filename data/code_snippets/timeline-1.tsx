...
export type Timeline1Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Timeline1 = (props: Timeline1Props) => {
...
export const Timeline1Defaults: Timeline1Props = {
  tagline: "Tagline",
