...
export type Login5Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Login5 = (props: Login5Props) => {
  const {
    logo,
    title,
    description,
...
export const Login5Defaults: Login5Props = {
  logo: {
    url: "#",
  ...
  testimonials: [
    {
      ...
      logo: {
        src: "https://relume-assets.s3.amazonaws.com/webflow-logo-v2.svg",
        alt: "Webflow logo 1",
      },
    },
    {
