...
export type Layout385Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Layout385 = (props: Layout385Props) => {
...
const Card = (card: Card) => {
  return (
    <div className="flex flex-col border border-border-primary first-of-type:grid first-of-type:auto-cols-fr first-of-type:grid-cols-1 sm:first-of-type:grid-cols-2 lg:first-of-type:col-span-2">
...
export const Layout385Defaults: Layout385Props = {
  tagline: "Tagline",
