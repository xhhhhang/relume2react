...
export type Testimonial28Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
export const Testimonial28 = (props: Testimonial28Props) => {
  const { heading, description, testimonials } = {
    ...Testimonial28Defaults,
    ...props,
  } as Props;
...
export const Testimonial28Defaults: Testimonial28Props = {
